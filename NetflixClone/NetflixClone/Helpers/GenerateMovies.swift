...
func generateMovies(_ count: Int) -> [Movie] {
    ...
    for _ in 0..<count {
        ...
        let movie = Movie(id: id, name: name, thumbnailURL: thumbnail, genre: categories, stdGenre: .AllGenres, year: year, rating: "PG-13", numberOfSeasons: numSeasons, cast: cast, creators: creators, currentEpisodeInfo: defEpiInfo, defaultEpisodeInfo: defEpiInfo, episodes: allEpisodes, promotionalHeadLine: headline, moreLikeThisMovies: moreLikeThis, trailers: allTrailers, previewImageName: "whiteLinesPreview")
...
func generateTrailers(_ count: Int) -> [Trailer] {
    ...
    for _ in 0..<count {
        ...
        let trailer = Trailer(id: id, name: name, videoURL: videoURL1!, thumbnailURL: thumbnail)
...
func generateEpisodes(_ count: Int, forSeason season: Int) -> [Episode] {
    ...
    for num in 0..<count {
        ...
        let episode = Episode(id: id, name: name, season: season, thumbnailURLString: thumbnail, description: desc, lenght: randLength, videoURL: videoURL2!, episodeNumber: num + 1)
